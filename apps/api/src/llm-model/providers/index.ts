...
import { constructOpenAiCompletionFn, constructOpenAiCompletionStreamFn } from './openai';
import {
...
export function getCompletionFnByModel({ model }: { model: LlmModel }): CompletionFn | undefined {
  if (model.provider === 'ionos') {
