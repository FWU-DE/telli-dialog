...
export const adminRouteHandlerDefinitions: Array<RouteHandlerDefinition> = [
  ...
  },
  {
    ...
    method: 'GET',
    schema: { hide: true },
    handler: v1_admin_organizations_$organizationId_projects_$projectId_getHandler,
  },
  {
    path: '/v1/admin/organizations/:organizationId/projects/:projectId',
    method: 'PUT',
    schema: { hide: true },
    handler: v1_admin_organizations_$organizationId_projects_$projectId_putHandler,
  },
  {
    path: '/v1/admin/organizations/:organizationId/projects/:projectId/api-keys',
    method: 'GET',
    schema: { hide: true },
    handler: v1_admin_organizations_$organizationId_projects_$projectId_apiKeys_getHandler,
  },
  {
  ...
  },
  {
    ...
    method: 'POST',
    schema: { hide: true },
    handler: v1_admin_organizations_$organizationId_projects_$projectId_apiKeys_postHandler,
  },
  {
