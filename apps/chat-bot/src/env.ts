...
export const env = createEnv({
  ...
  server: {
    ...
    llmSandboxUrl: z.url().optional(),
    llmSandboxApiToken: z.string().optional(),
  },
  runtimeEnv: {
    ...
    llmSandboxUrl: process.env.LLM_SANDBOX_URL,
    llmSandboxApiToken: process.env.LLM_SANDBOX_API_TOKEN,
  },
});
