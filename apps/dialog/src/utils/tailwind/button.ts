...
export const buttonPrimaryClassName =
  'px-4 py-3 text-button-primary-text bg-primary hover:bg-secondary hover:text-primary-hover-text rounded-enterprise-full disabled:bg-gray-200 disabled:text-gray-600 border border-transparent active:bg-secondary-dark';
