...
--> statement-breakpoint
ALTER TABLE "character" ADD COLUMN "is_deleted" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "character" ADD COLUMN "original_character_id" uuid;--> statement-breakpoint
ALTER TABLE "custom_gpt" ADD COLUMN "is_deleted" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "custom_gpt" ADD COLUMN "original_custom_gpt_id" uuid;--> statement-breakpoint
...
ALTER TABLE "character_template_mappings" ADD CONSTRAINT "character_template_mappings_federal_state_id_federal_state_id_fk" FOREIGN KEY ("federal_state_id") REFERENCES "public"."federal_state"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
