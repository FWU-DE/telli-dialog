...
ALTER TABLE "learning_scenario_template_mappings" ADD CONSTRAINT "learning_scenario_template_mappings_learning_scenario_id_fk" FOREIGN KEY ("learning_scenario_id") REFERENCES "public"."learning_scenario"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
WHERE "learning_scenario_id" NOT IN (SELECT "id" FROM "public"."learning_scenario");--> statement-breakpoint
