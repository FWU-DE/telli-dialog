...
DROP INDEX "text_chunk_file_id_index";--> statement-breakpoint
DROP INDEX "text_chunk_embedding_idx";--> statement-breakpoint
DROP INDEX "text_chunk_source_url_index";--> statement-breakpoint
