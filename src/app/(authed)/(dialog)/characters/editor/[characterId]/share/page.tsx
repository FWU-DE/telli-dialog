  ...
  return (
    <div className="w-full px-4 sm:px-8 overflow-auto flex flex-col h-full">
      ...
      >
        ...
        <span className="text-base font-normal hover:underline">Zum Dialogavatar</span>
      </Link>
      <div className="mx-auto mt-10 sm:mt-16 flex flex-col justify-center items-center text-center w-full">
        <h1 className="text-4xl sm:text-7xl font-medium mb-10 sm:mb-16">Dem Dialog beitreten</h1>
        <CountDownTimer
