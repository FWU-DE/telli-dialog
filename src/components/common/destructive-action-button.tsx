  ...
  return (
    <AlertDialog.Root open={isOpen}>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="z-50 fixed left-1/2 top-1/2 max-h-[85vh] w-fit -translate-x-1/2 -translate-y-1/2 rounded-enterprise-md bg-white p-10 max-w-xl">
