...
ALTER TABLE "shared_conversation_file_mapping" ADD CONSTRAINT "shared_conversation_file_mapping_fileId_file_table_id_fk" FOREIGN KEY ("fileId") REFERENCES "public"."file_table"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shared_conversation_file_mapping" ADD CONSTRAINT "shared_conversation_file_mapping_shared_school_conversation_id_shared_school_conversation_id_fk" FOREIGN KEY ("shared_school_conversation_id") REFERENCES "public"."shared_school_conversation"("id") ON DELETE no action ON UPDATE no action;